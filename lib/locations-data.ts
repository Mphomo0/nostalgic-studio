    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Yes. We build custom Next.js e-commerce stores with PayFast, Yoco, and Ozow integration, unlimited products, mobile-optimised checkout, and SEO product pages that rank on Google Shopping.',
          ...
          {
        q: 'You are based in Johannesburg — how does that work for a Cape Town client?',
        a: 'We are Johannesburg-based and serve Cape Town clients remotely. In practice this changes nothing: we run projects over email and video calls, share designs for review online, and most clients never need an in-person meeting. Your site is still built with Cape Town local SEO targeting.',
      },
      {
        q: 'How much does a website cost for a Cape Town business?',
        a: 'Starter sites begin at R1,500. Most Cape Town startups, agencies, and tourism businesses choose the R8,000–R15,000 business package. E-commerce for DTC brands runs R10,000–R25,000+ with South African payment gateways included. Every quote is fixed upfront, with no hourly billing.',
      },
      {
        q: 'Can you help my Cape Town business rank in local search?',
        a: 'Yes. We optimise your Google Business Profile and build content targeting the City Bowl, Century City, Claremont, and Tygervalley. For tourism and hospitality businesses, we focus on the seasonal search patterns that drive bookings. SEO packages start at R1,500/month.',
      },
    ],
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Yes. We integrate online booking engines into hotel, lodge, and B&B websites. This includes availability calendars, real-time booking, payment integration, and automated confirmation emails.',
          ...
          {
        q: 'Do you work with Durban businesses if you are based in Johannesburg?',
        a: 'Yes. We are Johannesburg-based and work with Durban and North Coast clients remotely, over email and video calls. You get the same process and the same local SEO targeting for Durban search terms — the only difference is we are unlikely to meet in person, and that rarely matters.',
      },
      {
        q: 'How much does a website cost for a Durban business?',
        a: 'Starter sites begin at R1,500. Most Durban businesses — hospitality, logistics, and property — choose the R8,000–R15,000 business package. Accommodation sites with booking systems and e-commerce stores run R10,000–R25,000+. All quotes are fixed before work starts.',
      },
      {
        q: 'Can you help my Durban tourism business get found online?',
        a: 'Yes. Tourism and hospitality searches in Durban are highly seasonal, so we build content and Google Business Profile optimisation around the booking cycles that matter — school holidays and summer peaks. We target Umhlanga, La Lucia, Ballito, and the Durban CBD. SEO from R1,500/month.',
      },
    ],
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Yes. We build SEO into every website from day one — including local SEO for Bloemfontein and Free State search terms, Google Maps integration, and structured data that helps Google understand your business. We also optimise for AI search visibility on ChatGPT and Gemini.',
          ...
          {
        q: 'Are you based in Bloemfontein?',
        a: 'No — we are based in Johannesburg and work with Bloemfontein clients remotely. Projects run over email and video calls, and you get the same fixed pricing and the same Bloemfontein local SEO targeting. We would rather be upfront about this than imply a local office we do not have.',
      },
      {
        q: 'How much does a website cost in Bloemfontein?',
        a: 'Starter websites begin at R1,500 for 5 pages with mobile-responsive design and basic SEO. Most Bloemfontein practices and SMEs choose the R8,000–R15,000 business package. Online stores run R10,000–R25,000+. Every quote is fixed, with no hourly rates or hidden fees.',
      },
      {
        q: 'How long does it take to build a Bloemfontein website?',
        a: 'A 5-page starter site takes 1–2 weeks. Most Bloemfontein business websites take 3–6 weeks including custom design, service pages, and SEO setup. E-commerce takes 8–12 weeks. Working remotely does not slow this down — the timeline is the same as for our Johannesburg clients.',
      },
    ],
    localCaseStudy: {

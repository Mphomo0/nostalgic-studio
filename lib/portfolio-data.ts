...
export const projects: Project[] = [
  {
    ...
    challenge: 'Sozim needed a modern website to replace their outdated online presence. Their previous site was slow, not mobile-friendly, and failed to communicate the breadth of their accredited training programmes to potential corporate clients.',
    approach: 'We built a Next.js website with server-side rendering for maximum SEO visibility. The design showcases their accreditations prominently, features a structured course catalogue, and includes clear calls-to-action for corporate enquiries.',
    results: [
  ...
  },
  {
    ...
    liveUrl: '#',
    slug: 'didee-holdings',
    challenge: 'Didee Holdings had no web presence and relied entirely on word-of-mouth for new business. They needed a professional website to establish credibility and attract government and corporate construction contracts.',
    approach: 'We delivered a clean, trust-focused design in just 2 weeks. The site emphasises safety certifications, completed project gallery, and clear service categories. Every page is optimised for local SEO targeting Johannesburg construction companies.',
    results: [
  ...
  },
  {
    ...
    slug: 'tanosa-group',
    challenge: 'Tanosa Group needed a website that could clearly communicate their diverse range of consulting services without overwhelming visitors. Their multidisciplinary approach required careful information architecture.',
    approach: 'We created a streamlined site architecture with dedicated service sections, a professional leadership page, and clear navigation pathways. The design uses a sophisticated colour palette that conveys trust and expertise.',
    results: [
  ...
  },
  {
    ...
    challenge: 'Jiyology Building & Construction needed a website to reach homeowners searching for renovation and plumbing services online. They wanted a site that felt approachable and professional for residential clients.',
    approach: 'We designed a bold, visually-driven website with prominent before-and-after project imagery. Each service category has its own dedicated page optimised for local search terms like "plumber Johannesburg" and "home renovation Gauteng".',
    results: [
  ...
  },
  {
    ...
    challenge: 'AZ Truck Sales needed a website that could showcase their truck inventory with detailed specifications, handle financing enquiries, and compete with larger dealerships in Gauteng. They needed lead generation, not just a brochure site.',
    approach: 'We built a feature-rich dealership platform with individual vehicle listing pages, filterable inventory, financing calculator integration, and WhatsApp quick-enquiry buttons. Each truck listing is optimised for search terms like "used trucks Gauteng" and "pre-owned [brand] trucks South Africa".',
    results: [
  ...
  },
  {
    ...
    liveUrl: '#',
    slug: 'bidco-trucks',
    challenge: 'Bidco Trucks serves clients across Africa and needed a website that could handle large inventory volumes, international enquiries, and showcase their extensive range of trucks, trailers, and plant equipment.',
    approach: 'We built a comprehensive inventory platform with category filtering, detailed equipment pages with multiple photos and specifications, and an integrated enquiry system. The site architecture supports SEO for both South African and broader African search markets.',
    results: [

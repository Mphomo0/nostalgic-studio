...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      'https://www.nostalgic-studio.co.za/services/seo-services-johannesburg',
    languages: {
      'en-ZA':
        'https://www.nostalgic-studio.co.za/services/seo-services-johannesburg',
      'x-default':
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Next.js provides superior SEO through server-side rendering (SSR) and static site generation (SSG), making it easier for search engine bots to crawl and index your content quickly. Next.js sites typically achieve 90–100 Lighthouse scores compared to 40–70 for WordPress.',
  },
  {
    question: 'How long does SEO take to show results?',
    answer:
      'SEO is a long-term strategy. Initial improvements appear in 3–4 months, with significant results typically achieved after 6–12 months of consistent optimization. However, technical SEO fixes can show improvements in 2–4 weeks.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'We offer comprehensive technical SEO including site speed optimization, XML sitemaps, robots.txt configuration, schema markup, canonical tags, Core Web Vitals improvement, mobile responsiveness, and structured data implementation for Next.js websites.',
  },
  {
    question: 'Do you guarantee Google rankings?',
    answer:
      'No ethical SEO provider can guarantee specific rankings. We promise transparent reporting, white-hat techniques, and measurable improvements in traffic, keyword rankings, and conversions. We focus on sustainable, long-term SEO strategies.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Traditional SEO optimizes for search engine result pages (SERPs) with keywords and backlinks. GEO optimizes for AI answer engines by focusing on entity authority, structured data, direct answers, authoritative citations, and content that AI models can confidently reference as source material. They complement each other — classic SEO drives Google traffic, GEO drives AI citation visibility.',
  },
  {
    question: 'How long does SEO take in South Africa?',
    answer:
      'Some technical changes can be picked up quickly, but SEO usually takes weeks or months to show clear results. The fastest improvements usually come from fixing page titles, improving service pages, adding internal links, updating Google Business Profile, and requesting indexing in Google Search Console.',
  },
]
...
const seoProcess = [
  {
    ...
    description:
      'We analyse your current website, competitors, and target keywords — plus assess your GEO readiness and AI citation potential — to build a dual SEO + AI search strategy.',
  },
  {
    icon: Target,
    title: 'On-Page + AI Content',
    description:
      'We optimise title tags, meta descriptions, headings, and content for both Google ranking and AI answer extraction. Structured Q&A, entity signals, and citation-worthy copy built in.',
  },
  {
    icon: Shield,
    title: 'Technical + Structured Data',
    description:
      'We fix crawl errors, improve site speed, implement JSON-LD schema, optimise Core Web Vitals, and add AI-friendly structured data that helps models understand and cite your content.',
  },
  {
    icon: Link2,
    title: 'Off-Page, Local & GEO',
    description:
      'We build high-quality backlinks, optimise your Google Business Profile, manage citations — and build entity authority across the web so AI engines trust and reference your brand.',
  },
  {
    icon: BarChart3,
    title: 'Reporting & Refinement',
    description:
      'We provide monthly reports showing keyword rankings, organic traffic, conversions, and AI citation metrics. We continuously refine both classic SEO and GEO strategy based on data.',
  },
]
...
const localIndustries = [
  {
    ...
    description:
      'SEO for plumbers, electricians, cleaners, and home service providers targeting Johannesburg suburbs.',
  },
  {
    name: 'Construction Companies',
    description:
      'Rank for building, renovation, and construction keywords in Gauteng and surrounding provinces.',
  },
  {
    name: 'Trades Businesses',
    description:
      'Local SEO for painters, carpenters, roofers, and tradespeople across Johannesburg and Pretoria.',
  },
  {
    name: 'Professional Services',
    description:
      'Lawyers, accountants, consultants, and financial advisors targeting high-intent local searches.',
  },
  {
    name: 'Healthcare Providers',
    description:
      'SEO for doctors, dentists, physiotherapists, and wellness practitioners in Johannesburg.',
  },
  {
    name: 'E-Commerce Stores',
    description:
      'Technical SEO and content optimisation for online stores selling to South African customers.',
  },
]
...
const geoFeatures = [
  {
    ...
    description:
      'Optimise content so ChatGPT cites your business as a trusted source for SEO services in South Africa.',
  },
  {
    icon: Zap,
    title: 'Gemini & Claude Ready',
    description:
      'Structure data for Google Gemini and Anthropic Claude to extract and attribute your expertise.',
  },
  {
    icon: Globe,
    title: 'Perplexity Optimised',
    description:
  ...
  },
  {
    ...
    description:
      'Build entity authority through structured data, topic clusters, and consistent NAP information across the web.',
  },
]
  ...
  return (
    <main className="pt-32 pb-20">
      ...
      <div className="container-wide mx-auto px-4">
        ...
        <MotionWrapper>
          <div className="max-w-4xl mx-auto text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              ...
              Business Profile improvements, content strategy, and conversion
              tracking.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Button asChild size="lg" className="h-14 px-8">
                <Link href="/contact">
                  Get Your Free SEO Audit <ArrowRight className="ml-2" />
                </Link>
              </Button>
              <Button
                asChild
        ...
        {/* What We Fix First */}
        <section className="mb-16" aria-labelledby="fix-first-heading">
          <div className="bg-card border border-border rounded-3xl p-8 md:p-12">
            <h2 id="fix-first-heading" className="text-2xl font-bold mb-4">
              What We Fix First
            </h2>
            <p className="text-muted-foreground mb-6">
              Before writing more blog posts or chasing backlinks, we fix the
              foundation:
            </p>
            <ul className="grid gap-3 text-muted-foreground list-disc list-inside marker:text-primary">
              ...
              <li>Missing or weak service page content</li>
              <li>Poor heading structure</li>
              <li>Slow or heavy pages</li>
              <li>Missing internal links</li>
              <li>Weak calls-to-action</li>
              <li>Google Business Profile gaps</li>
              <li>Missing schema markup</li>
              <li>Thin pages with too little useful information</li>
              <li>Pages that target the wrong keyword</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-16" aria-labelledby="definition-heading">
          <div className="bg-card border border-border rounded-3xl p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground mb-8">
              ...
              <p>
                <strong>Classic SEO</strong> encompasses technical SEO, on-page
                content optimisation, off-page link building, and local SEO
                designed to improve a website&apos;s ranking in search engine
                results pages (SERPs). It&apos;s the foundation — site speed,
                crawlability, keyword targeting, and backlinks that have driven
                organic traffic for two decades.
              </p>
              <p>
                <strong>AI Search / GEO</strong> (Generative Engine
                Optimization) optimises your content for AI answer engines.
                These models pull from structured data, entity signals,
                authoritative citations, and clear answer-focused content to
                generate responses. Being cited by ChatGPT or appearing in
                Google AI Overviews is the new frontier of discoverability.
              </p>
              <p>
                <strong>Why it matters for Johannesburg businesses:</strong> AI
                search tools are becoming part of how people discover businesses,
                compare providers, and ask for recommendations. That means your
                website should be easy for both search engines and AI tools to
                understand.
              </p>
            </div>
          </div>
        ...
        <section className="mb-16" aria-labelledby="geo-heading">
          <div className="bg-card border border-border rounded-3xl p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              ...
              <ul>
                <li>
                  <strong>Entity optimisation:</strong> We build entity
                  authority through structured data (JSON-LD), topic clusters,
                  and consistent NAP information that AI engines use to verify
                  your business.
                </li>
                <li>
                  <strong>Answer-focused content:</strong> We create clear,
                  authoritative answers to common questions in your industry,
                  structured for AI extraction and citation.
                </li>
                <li>
                  <strong>Structured data implementation:</strong> Schema markup
                  helps AI models understand your content context, making it
                  more likely to be referenced in AI-generated answers.
                </li>
                <li>
                  <strong>Citation-worthy authority:</strong> We build your
                  reputation through expert author bios, original research, and
                  comprehensive guides that AI models trust as source material.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-16" aria-labelledby="snippet-heading">
          <div className="bg-card border border-border rounded-3xl p-8 md:p-12">
            ...
            <p className="text-lg text-muted-foreground">
              Nostalgic Studio is a leading{' '}
              <strong>SEO and AI search agency in Johannesburg</strong>,
              specializing in technical SEO, local SEO, Generative Engine
              Optimization (GEO), and{' '}
              <strong>Next.js website optimization</strong> for businesses
              across South Africa. Our dual approach combines proven classic SEO
              strategies with cutting-edge GEO techniques to deliver measurable
              results. We help businesses increase organic traffic, improve
              Google rankings, get cited by AI answer engines, and grow their
              online presence through comprehensive search solutions tailored to
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  'Most Johannesburg businesses invest little in SEO and almost none in GEO. A dual strategy gives you a significant edge over competitors relying on outdated methods.',
              },
              {
                icon: DollarSign,
              ...
              },
              {
                ...
                description:
                  'Ranking on Google and being cited by AI engines signals trust and authority. Customers trust businesses that appear at the top of both search results and AI answers.',
              },
              {
                icon: BarChart3,
        ...
        <section className="mb-16" aria-labelledby="process-heading">
          ...
          <p className="text-center text-muted-foreground mb-10 max-w-2xl mx-auto">
            We follow a proven, data-driven process that combines classic SEO
            with AI search optimisation — designed to deliver sustainable
            visibility across Google and AI answer engines for Johannesburg
            businesses.
          </p>
            ...
            {[
              {
                ...
                items: [
                  ...
                  'Canonical tags & redirect management',
              ...
              },
              {
                ...
                items: [
                  ...
                  'Guest posting & contributor content',
        ...
        <section className="mb-16" aria-labelledby="local-seo-heading">
          <div className="bg-card border border-border rounded-3xl p-8 md:p-12">
            ...
            <p className="text-muted-foreground mb-6">
              Johannesburg is a competitive market with diverse suburbs and
              business districts. Effective local SEO ensures your business
              appears when potential customers search for your services in
              specific areas — whether they search on Google, ask ChatGPT, or
              use AI Overviews.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <p className="text-muted-foreground">
              We optimise for Johannesburg-specific search terms, including
              suburb-level keywords (Sandton, Midrand, Soweto, Randburg,
              Roodepoort), landmark references (Maboneng, Rosebank, Fourways),
              and service-area targeting for businesses that serve specific
              parts of Gauteng.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16 text-center">
          <div className="bg-primary/5 border border-primary/20 rounded-3xl p-10 md:p-16">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Rank on Google & AI Search?
            </h2>
            ...
            <Button asChild size="lg" className="h-14 px-10">
              <Link href="/contact">
                Claim Your Free SEO Audit <ArrowRight className="ml-2" />
              </Link>
            </Button>
          </div>
        </section>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-card p-8 rounded-2xl border border-border">
              ...
              <div className="text-3xl font-bold text-primary mb-4">
                R1,500<span className="text-sm text-muted-foreground">/mo</span>
              </div>
              <p className="text-sm text-muted-foreground mb-6">
            ...
            <div className="bg-primary/5 p-8 rounded-2xl border border-primary/30 relative">
              ...
              <div className="text-3xl font-bold text-primary mb-4">
                R5,000<span className="text-sm text-muted-foreground">/mo</span>
              </div>
              <p className="text-sm text-muted-foreground mb-6">
                For growing businesses ready to dominate their market.
              </p>
              <ul className="space-y-2 mb-8">
                {[
                  'Keyword research (30 keywords)',
                  'On-page optimisation (15 pages)',
            ...
            <div className="bg-card p-8 rounded-2xl border border-border">
              ...
              <div className="text-3xl font-bold text-primary mb-4">
                R10K+<span className="text-sm text-muted-foreground">/mo</span>
              </div>
              <p className="text-sm text-muted-foreground mb-6">
                Comprehensive SEO for established businesses and competitive
                markets.
              </p>
              <ul className="space-y-2 mb-8">
                {[
          ...
          <div className="bg-card border border-border rounded-2xl p-8">
            <h3 className="text-xl font-bold mb-4">
              SEO & AI Search Timeline: What to Expect
            </h3>
        ...
        <section className="mb-16" aria-labelledby="mistakes-heading">
          <div className="bg-card border border-border rounded-3xl p-8 md:p-12">
            ...
            <p className="text-muted-foreground mb-6">
              Many businesses waste time and money on SEO strategies that
              don&apos;t work. Here are the most common mistakes we see
              Johannesburg businesses make — including the new ones that hurt AI
              search visibility:
            </p>
        ...
        <section className="mb-16">
          <div className="bg-card border border-border rounded-3xl p-8 md:p-12 text-center">
            <h2 className="text-3xl font-bold mb-4">
              Why Choose Nostalgic Studio for SEO & AI Search?
            </h2>
            <div className="grid md:grid-cols-3 gap-6 mt-8 mb-8 text-left">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  As Next.js experts, we build SEO advantages into your website
                  architecture — server-side rendering, sub-2s load times, and
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  We use only white-hat SEO techniques. No shortcuts, no
                  black-hat tricks — just sustainable strategies that build
                  lasting authority for your brand.
                </p>
              </div>
              <div className="p-4">
                <h3 className="font-bold mb-2">Data-Driven Decisions</h3>
                <p className="text-sm text-muted-foreground">
                  Every strategy is backed by data. We track keyword rankings,
                  organic traffic, conversions, and ROI. You get monthly reports
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  SEO doesn&apos;t exist in isolation. We also offer web design,
                  branding, content creation, and social media — everything
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  We understand Johannesburg&apos;s competitive landscape. From
                  Sandton to Soweto, our local SEO strategies are tailored to
                  the South African market.
                </p>
              </div>
            </div>
        ...
        <KeyTakeaways
          takeaways={[
            ...
            },
            {
              ...
              detail:
                'site speed, crawlability, and Core Web Vitals directly impact rankings and user experience',
            },
            {
              point: 'Local SEO specialists',
              detail:
                'Google Business Profile and Johannesburg-specific optimisations that drive foot traffic and local leads',
            },
            {
              point: 'Long-term results',
              detail:
                'organic traffic compounds over time unlike paid ads that stop when budgets do',
            },
            {
              point: 'Transparent reporting',
              detail:
                'monthly reports with keyword rankings, traffic growth, conversions, and AI citation metrics',
            },
            {
              point: 'White-hat only',
              detail:
                'ethical SEO techniques that build lasting authority without risk of Google penalties',
            },
          ]}
        />
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                How to rank in ChatGPT, Gemini & Google AI Overviews.
              </p>
            </Link>
            <Link
              href="/blog/seo-for-startups-south-africa"
              className="bg-card p-5 rounded-2xl border border-border hover:border-primary/50 transition-colors"
            >
              <p className="text-xs font-semibold text-primary uppercase tracking-wide mb-1">
                SEO Strategy
              ...
              <p className="text-sm text-muted-foreground">
                Compete with established brands on a lean budget.
              </p>
            </Link>
          </div>
        </section>
        ...
        <section className="mb-16" aria-labelledby="related-heading">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                SEO-optimised, AI-friendly websites built with Next.js for
                maximum performance.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Paid campaigns that complement your organic SEO strategy for
                full-funnel growth.
              </p>
            </Link>
            <Link
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-6">
            Ready to Own Search — Classic & AI?
          </h2>

    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Free Web Design Quote Johannesburg — Nostalgic Studio',
      },
    ],
  },
  twitter: {
...
const contactFaqs = [
  {
    ...
    answer:
      'Our web design projects start from R1,500 for simple brochure sites, R8,000–R15,000 for business websites, and R10,000–R25,000+ for e-commerce platforms. During your free consultation, we provide a fixed quote based on your specific requirements. There are no hourly rates — you get a clear, upfront price.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, we offer comprehensive SEO services including technical SEO, local SEO, content strategy, and GEO (Generative Engine Optimization) for businesses in Johannesburg and across South Africa.',
  },
  {
    question: 'How quickly do you respond to enquiries?',
    answer:
      'We respond to all enquiries within 24 hours, usually much sooner. For urgent projects, we recommend calling us directly at 082 448 3273 for an immediate response.',
  },
]
  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="pt-24 pb-12 md:pt-32 md:pb-20 container mx-auto px-4 md:px-8">
        ...
        <section
          className="mt-20 border-t border-border pt-16 text-center"
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto text-left">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <WhatsAppIcon className="w-12 h-12 text-primary mt-0.5" />
                  <div>
        ...
        <section className="mt-16" aria-labelledby="trust-heading">
          <h2 id="trust-heading" className="text-xl font-bold mb-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                We start with a free 30-minute consultation to understand your
                business goals, target audience, and project requirements. There
                is no obligation — just a focused conversation about what you
            ...
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Within 24 hours of your enquiry, we send a detailed project
                proposal outlining the scope of work, timeline, deliverables,
                and a fixed price. No hidden fees — you know exactly what you
            ...
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Once approved, we move into design and development. Most
                websites launch within 4–8 weeks. You receive regular progress
                updates and have full input at every stage. After launch, we
                provide 30-day post-launch support at no additional cost.
              </p>
            </div>
          </div>
        </section>
